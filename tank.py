...
class Bullet:
    def __init__(self, bullet_x = 0, bullet_y = 0, bullet_color = (0, 0, 255), direction = 'RIGHT', bullet_speed = 10):
    ...
    def draw_bullet(self):
        pygame.draw.circle(screen, self.bullet_color, (self.bullet_x, self.bullet_y), 4)
...
def bullet_shoot(tank):
    ...
    bul = Bullet(bullet_x, bullet_y, (0, 0, 255), tank.direction)
    bullets.append(bul)
    ...
    for bul in bullets:
        ...
        if tanks[0].lives == 0 or tanks[1].lives == 0:
            ...
            if tanks[0].lives == 0:
                ...
                text2 = font2.render('Winner is tank1', True, (255 , 255 , 255))
                place2 = text2.get_rect(center=(400, 500))
                screen.blit(text2, place2)

            if tanks[1].lives == 0:
                font3 = pygame.font.SysFont("Arial", 18)
                text3 = font3.render('Winner is tank2', True, (255 , 255 , 255))
